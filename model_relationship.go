...
type Relationship struct {
	// Business that the current account is associated with
	BusinessId *string `json:"business_id,omitempty"`
	// Customer that the current account is associated with (deprecated)
	// Deprecated
	CustomerId *string `json:"customer_id,omitempty"`
	// ID of account relationship
	Id *string `json:"id,omitempty"`
	// Person that the current account is associated with
