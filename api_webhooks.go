...
func (r ApiListEventsRequest) StartDate(startDate oapi.Date) ApiListEventsRequest {
	r.startDate = &startDate
	return r
}

// End date of the search range
func (r ApiListEventsRequest) EndDate(endDate oapi.Date) ApiListEventsRequest {
	r.endDate = &endDate
	return r
}
...
func (r ApiReplaceSecretRequest) Execute() (InlineResponse2001, *_nethttp.Response, error) {
...
func (a *WebhooksApiService) ReplaceSecretExecute(r ApiReplaceSecretRequest) (InlineResponse2001, *_nethttp.Response, error) {
	var (
