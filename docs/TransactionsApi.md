...
func main() {
    ...
    resp, r, err := api_client.TransactionsApi.CreateInternalTransfer(context.Background()).InternalTransfer(internalTransfer).IdempotencyKey(idempotencyKey).Execute()
    if err != nil {
