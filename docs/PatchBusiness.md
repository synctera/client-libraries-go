...
**Ein** | Pointer to **string** | U.S. Employer Identification Number (EIN) for this business, in the format 999-99-9999. | [optional] 
**Email** | Pointer to **string** | Business&#39;s email. | [optional] 
**EntityName** | Pointer to **string** | Business&#39;s legal name. | [optional] 
**FormationDate** | Pointer to [**oapi.Date**](oapi.Date.md) | Date the business was legally registered in RFC 3339 full-date format (YYYY-MM-DD). | [optional] 
...
**PhoneNumber** | Pointer to **string** | Business&#39;s phone number with country code in E.164 format. | [optional] 
...
`func (o *PatchBusiness) GetFormationDate() oapi.Date`

GetFormationDate returns the FormationDate field if non-nil, zero value otherwise.

### GetFormationDateOk

`func (o *PatchBusiness) GetFormationDateOk() (*oapi.Date, bool)`
...
`func (o *PatchBusiness) SetFormationDate(v oapi.Date)`
