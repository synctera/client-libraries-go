...
`func NewAccountProduct(productType string, calculationMethod CalculationMethod, rates []RateDetails, accrualPayoutSchedule AccrualPayoutSchedule, feeType string, amount int64, currency string, ) *AccountProduct`
