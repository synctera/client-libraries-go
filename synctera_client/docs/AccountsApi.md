...
func main() {
    accountId := "12dbc24c-3cfc-46dc-a164-0977434afabf" // string | Unique identifier for the account.
...
func main() {
    accountTemplate := *openapiclient.NewAccountTemplate(false, "Name_example", openapiclient.template_fields{TemplateFieldsDepository: openapiclient.NewTemplateFieldsDepository(openapiclient.account_type("SAVING"), "US", "USD")}) // AccountTemplate | Account template to create
    idempotencyKey := "df122e6f-2ba8-48a5-9508-4350bba5f27e" // string | An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key (optional)
...
func main() {
    accountId := "12dbc24c-3cfc-46dc-a164-0977434afabf" // string | Unique identifier for the account.
    relationshipId := "1558a413-6b1c-45e0-8da0-386ae5b46b75" // string | Relationship ID of the account associate with the account entity
...
func main() {
    templateId := "72aad5e2-302a-4683-8d33-2510afae6eab" // string | Account Template ID
...
func main() {
    productId := "95a2e06d-83ab-458b-b3b8-962941411ee6" // string | Account Product ID
...
func main() {
    templateId := "72aad5e2-302a-4683-8d33-2510afae6eab" // string | Account Template ID
    accountTemplate := *openapiclient.NewAccountTemplate(false, "Name_example", openapiclient.template_fields{TemplateFieldsDepository: openapiclient.NewTemplateFieldsDepository(openapiclient.account_type("SAVING"), "US", "USD")}) // AccountTemplate | Account template to update
