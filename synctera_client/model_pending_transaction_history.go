...
func NewPendingTransactionHistory(accountId string, accountNo string, created time.Time, data PendingTransactionHistoryData, id int64, idemkey string, offsetAccountId string, offsetAccountNo string, referenceId NullableString, tenant string, updated time.Time, uuid string) *PendingTransactionHistory {
	...
	this.OffsetAccountNo = offsetAccountNo
...
// GetOffsetAccountId returns the OffsetAccountId field value
...
// GetOffsetAccountIdOk returns a tuple with the OffsetAccountId field value
// and a boolean to check if the value has been set.
...
// SetOffsetAccountId sets field value
func (o *PendingTransactionHistory) SetOffsetAccountId(v string) {
	o.OffsetAccountId = v
}

// GetOffsetAccountNo returns the OffsetAccountNo field value
...
// GetOffsetAccountNoOk returns a tuple with the OffsetAccountNo field value
// and a boolean to check if the value has been set.
...
// SetOffsetAccountNo sets field value
