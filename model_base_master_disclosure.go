...
type BaseMasterDisclosure struct {
...
func (o BaseMasterDisclosure) MarshalJSON() ([]byte, error) {
...
type NullableBaseMasterDisclosure struct {
	value *BaseMasterDisclosure
	isSet bool
}

func (v NullableBaseMasterDisclosure) Get() *BaseMasterDisclosure {
	return v.value
}

func (v *NullableBaseMasterDisclosure) Set(val *BaseMasterDisclosure) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseMasterDisclosure) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseMasterDisclosure) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseMasterDisclosure(val *BaseMasterDisclosure) *NullableBaseMasterDisclosure {
	return &NullableBaseMasterDisclosure{value: val, isSet: true}
}

func (v NullableBaseMasterDisclosure) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseMasterDisclosure) UnmarshalJSON(src []byte) error {
	v.isSet = true
