...
func (r ApiListPendingTransactionsRequest) FromDate(fromDate oapi.Date) ApiListPendingTransactionsRequest {
	r.fromDate = &fromDate
	return r
}

// Only display transactions with a posting date less than or equal to to_date
func (r ApiListPendingTransactionsRequest) ToDate(toDate oapi.Date) ApiListPendingTransactionsRequest {
	r.toDate = &toDate
	return r
}
...
// Only display transactions with a posting date greater than from_date
func (r ApiListPostedTransactionsRequest) FromDate(fromDate oapi.Date) ApiListPostedTransactionsRequest {
	r.fromDate = &fromDate
	return r
}

// Only display transactions with a posting date less than or equal to to_date
func (r ApiListPostedTransactionsRequest) ToDate(toDate oapi.Date) ApiListPostedTransactionsRequest {
	r.toDate = &toDate
	return r
}
