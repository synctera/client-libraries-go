...
func (r ApiCreateInternalTransferRequest) Execute() (InternalTransfer, *_nethttp.Response, error) {
...
func (a *TransactionsApiService) CreateInternalTransferExecute(r ApiCreateInternalTransferRequest) (InternalTransfer, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  InternalTransfer
	)
