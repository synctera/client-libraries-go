...
> InternalTransfer CreateInternalTransfer(ctx).IdempotencyKey(idempotencyKey).InternalTransfer(internalTransfer).Execute()
...
func main() {
    ...
    internalTransfer := *openapiclient.NewInternalTransfer(int32(123), "USD", "OriginatingAccountId_example", "ReceivingAccountId_example", "outgoing_remittance") // InternalTransfer | Transfer request body
    ...
    // response from `CreateInternalTransfer`: InternalTransfer
...
[**InternalTransfer**](InternalTransfer.md)
