...
type CardChange struct {
	...
	Reason *CardChangeReasonCode `json:"reason,omitempty"`
...
// SetReason gets a reference to the given CardChangeReasonCode and assigns it to the Reason field.
