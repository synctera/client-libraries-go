...
type InternalTransfer struct {
	...
	// The full name of the owner of the receiving account. Only required when type is \"outgoing_remittance\"
	ReceivingAccountFullname *string `json:"receiving_account_fullname,omitempty"`
...
// GetReceivingAccountFullname returns the ReceivingAccountFullname field value if set, zero value otherwise.
func (o *InternalTransfer) GetReceivingAccountFullname() string {
	if o == nil || o.ReceivingAccountFullname == nil {
		var ret string
		return ret
	}
	return *o.ReceivingAccountFullname
}

// GetReceivingAccountFullnameOk returns a tuple with the ReceivingAccountFullname field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalTransfer) GetReceivingAccountFullnameOk() (*string, bool) {
	if o == nil || o.ReceivingAccountFullname == nil {
		return nil, false
	}
	return o.ReceivingAccountFullname, true
}
...
// SetReceivingAccountFullname gets a reference to the given string and assigns it to the ReceivingAccountFullname field.
func (o *InternalTransfer) SetReceivingAccountFullname(v string) {
	o.ReceivingAccountFullname = &v
}
...
func (o InternalTransfer) MarshalJSON() ([]byte, error) {
	...
	if o.ReceivingAccountFullname != nil {
		toSerialize["receiving_account_fullname"] = o.ReceivingAccountFullname
	}
	if true {
