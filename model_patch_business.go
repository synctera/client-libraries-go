...
type PatchBusiness struct {
	...
	// U.S. Employer Identification Number (EIN) for this business, in the format 999-99-9999.
	...
	FormationDate *oapi.Date `json:"formation_date,omitempty"`
	...
	// Distinguish personal and business customers from non-customer parties.
	...
	// Business's phone number with country code in E.164 format.
...
// SetFormationDate gets a reference to the given oapi.Date and assigns it to the FormationDate field.
