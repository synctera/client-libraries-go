...
type BalanceFloor struct {
	...
	OverdraftAccountId string `json:"overdraft_account_id"`
}
...
// GetOverdraftAccountId returns the OverdraftAccountId field value
...
// GetOverdraftAccountIdOk returns a tuple with the OverdraftAccountId field value
// and a boolean to check if the value has been set.
...
// SetOverdraftAccountId sets field value
