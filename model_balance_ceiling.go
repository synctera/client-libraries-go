...
type BalanceCeiling struct {
	...
	OverflowAccountId string `json:"overflow_account_id"`
}
...
func NewBalanceCeiling(balance int64, overflowAccountId string) *BalanceCeiling {
	...
	this.OverflowAccountId = overflowAccountId
	return &this
}
...
// GetOverflowAccountId returns the OverflowAccountId field value
...
// GetOverflowAccountIdOk returns a tuple with the OverflowAccountId field value
// and a boolean to check if the value has been set.
...
// SetOverflowAccountId sets field value
