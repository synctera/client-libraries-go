...
// TemplateFieldsOverdraft struct for TemplateFieldsOverdraft
type TemplateFieldsOverdraft struct {
...
func (o TemplateFieldsOverdraft) MarshalJSON() ([]byte, error) {
...
type NullableTemplateFieldsOverdraft struct {
	value *TemplateFieldsOverdraft
	isSet bool
}

func (v NullableTemplateFieldsOverdraft) Get() *TemplateFieldsOverdraft {
	return v.value
}

func (v *NullableTemplateFieldsOverdraft) Set(val *TemplateFieldsOverdraft) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateFieldsOverdraft) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateFieldsOverdraft) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateFieldsOverdraft(val *TemplateFieldsOverdraft) *NullableTemplateFieldsOverdraft {
	return &NullableTemplateFieldsOverdraft{value: val, isSet: true}
}

func (v NullableTemplateFieldsOverdraft) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateFieldsOverdraft) UnmarshalJSON(src []byte) error {
	v.isSet = true
